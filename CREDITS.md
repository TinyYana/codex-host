...
| Harness／產品品牌圖示 | 實際素材使用、裁切或變體，不是架構 inspiration；來源與改動見 [Renderer assets](packages/renderer-extension/src/assets/README.md) 及 [Launcher assets](crates/launcher/assets/README.md)。根 LICENSE 不代表授予第三方品牌權利。 |
